...
n      (cyberpunk-magenta "#dc8cc3")
 ...
 (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((,class (:foreground ,cyberpunk-blue))))
   ...
   `(font-lock-type-face ((,class (:foreground ,cyberpunk-red))))
